...
describe("Testes para função somar", () => {
  ...
  it(
    "CT2 - Deve somar um número negativo e um número " +
  ...
  it(
    "CT3 - Deve somar um número positivo e um número " +
  ...
  it(
    "CT6 - Deve inserir 'batata' no 1º parâmetro e um número " +
  ...
  it(
    "CT7 - Deve inserir um número positivo no 1º parâmetro e " +
...
describe("Testes para função subtrair", () => {
  ...
  it("CT14 - Deve subtrair 2 números decimais e retornar 5.4", () => {
    expect(Service.Subtrair(2.6, 3.7)).toBe(-1.1);
  });

  it(
    "CT15 - Deve inserir 'banana' no 1º parâmetro e um número " +
      "positivo no 2º parâmetro e retornar um erro",
    () => {
  ...
  it(
    "CT16 - Deve inserir um número positivo no 1º parâmetro e " +
...
describe("Testes para função multiplicar", () => {
  ...
  it(
    "CT24 - Deve inserir 'morango' no 1º parâmetro e um número " +
      "positivo no 2º parâmetro e retornar um erro",
    () => {
  ...
  it(
    "CT25 - Deve inserir um número positivo no 1º parâmetro e " +
...
describe("Testes para função dividir", () => {
  ...
  it("CT31 - Deve dividir 0 por 5 e retornar 0", () => {
  ...
  it(
    "CT33 - Deve inserir 'abacaxi' no 1º parâmetro e um número " +
      "positivo no 2º parâmetro e retornar um erro",
    () => {
  ...
  it(
    "CT34 - Deve inserir um número positivo no 1º parâmetro e " +
